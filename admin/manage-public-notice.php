...
$sql="SELECT ID as nid,NoticeTitle,NoticeMessage,CreationDate from tblpublicnotice";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="public-email-send.php?nid=<?php echo htmlentities ($row->nid);?>"><i class="icon-share-alt"></i></a>||
                                <a href="edit-public-notice-detail.php?editid=<?php echo htmlentities ($row->nid);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-public-notice.php?delid=<?php echo ($row->nid);?>" onclick="return confirm('Do you really want to Delete ?');"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
