...
<td colspan="4" style="font-size:20px;color:blue">
 Students Details</td></tr>
  ...
  <tr class="table-progress">
   ...
   <tr class="table-info">
    <th>Profile Pics</th>
    <td><img src="../user/images/<?php echo $row->Image;?>"></td>
   <th>Resume</th>
    <td><a href="../user/images/<?php echo $row->resume;?>"><?php echo $row->resume;?></a></td>
  </tr>
   <tr class="table-danger">
