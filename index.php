...
<html>
<head>
<title>YBP Training and Placement || Home Page</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <h3>YBP Training and Placement Cell</h3>      
...
{               ?>
		<br><h2 style="text-align: center;color: red;"><?php  echo htmlentities($row->PageTitle);?></h2>
		<br><p><?php  echo ($row->PageDescription);?></p><?php $cnt=$cnt+1;}} ?>
	</div>
<!--/welcome-->
...
<div class="testimonials">
	<div class="container">
        ...
        <h3 style="color: red">Public Notices</h3>
